...
-- There is 1 team in Ohio.

-- What's the oldest team in the league, and what year?
-- The oldest team is the Atlanta Hawks, founded in 1949.
...
-- Clause:
-- A clause is a part of an SQL statement that specifies a condition or action.
