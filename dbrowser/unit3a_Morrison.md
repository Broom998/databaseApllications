...
|---|---|---|---|---|
| 1 |247 |home_team |Chicago Buls |Chicago Bulls |
| 2 |62 |home_team |Clevland Cavaliers |Cleveland Cavaliers |
| 3 |108 |away_team |Pheonix Suns |Phoenix Suns |
| 4 |206 |away_team |Chicago Bull |Chicago Bulls |
| 5 |202 |home_city |Philidelphia |Philadelphia |
| 6 |241 |home_state |IL |Illinois |
| 7 |103 |away_state |OH |Ohio |
| 8 |257 |away_state |TX |Tennessee |
...
**Answer:Home city as home team has one mispelled value**
...
**What goes wrong:All of Art one is deleted**
...
**What goes wrong: She wont appear in the database at all**
...
**What goes wrong:One mispelling will cause a student to be unable to come to her class**
...
**Answer: Teahcer + Room + Course
Because Then all teachers will be accounted for and if they have no students they will still exist**
...
|---|---|
| Redundancy |Human error throught repetition |
| Update anomaly |A fact changes that creates room for redundancy |
| Insert anomaly |No viable way to show a fact |
| Delete anomaly |Deleting more than what was intended |
| Normalization |A synonym to organization and making sure everything is in the correct place |
